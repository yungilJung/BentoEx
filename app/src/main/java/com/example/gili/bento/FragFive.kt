 ...
 * [FragFive.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragFive.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class FragFive : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val currentRequest = StringRequest(Request.Method.GET, "http://jdv.iptime.org:8181/api/productList/반찬", Response.Listener { response -> parseJsonCurrent(this!!.getContext()!!, response, queue) }, Response.ErrorListener { })
    ...
    companion object {
         ...
         * @return A new instance of fragment FragFive.
         */
