 ...
 * [FragTwo.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragTwo.newInstance] factory method to
...
class FragTwo : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val currentRequest = StringRequest(Request.Method.GET, "http://jdv.iptime.org:8181/api/productList/도시락용기", Response.Listener { response -> parseJsonCurrent(this!!.getContext()!!, response, queue) }, Response.ErrorListener { })
