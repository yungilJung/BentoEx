 ...
 * [FragThree.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragThree.newInstance] factory method to
...
class FragThree : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val currentRequest = StringRequest(Request.Method.GET, "http://jdv.iptime.org:8181/api/productList/보울용기", Response.Listener { response -> parseJsonCurrent(this!!.getContext()!!, response, queue) }, Response.ErrorListener { })
