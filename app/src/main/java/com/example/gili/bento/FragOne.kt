 ...
 * [FragOne.OnFragmentInteractionListener] interface
...
class FragOne : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val currentRequest = StringRequest(Request.Method.GET, "http://jdv.iptime.org:8181/api/productMainList", Response.Listener { response -> parseJsonCurrent(this!!.getContext()!!, response, queue) }, Response.ErrorListener { })
...
//            throw RuntimeException(context.toString() + " must implement OnFragmentInteractionListener")
    ...
    fun parseJsonCurrent(context: Context, response: String, queue: RequestQueue){
        ...
        for(x in 0..jarray.length()-1){
            ...
            item.MidCategory =jObject.getString("MidCategory")
            list.add(item);
        }
